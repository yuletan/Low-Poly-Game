...
export const UNIT_TYPES = {
  ...
  destroyer:{ domain:'sea',   hp:250, damage:45, range:60, speed:12, fireRate:1.2, hitChance:0.85, cost:250, color:0x8899aa, canFireWhileMoving:true, bounty:150, projectile:'dual', splashRadius:10, splashFalloff:0.5 },
  battleship:{domain:'sea',   hp:600, damage:130, range:100, speed:7,  fireRate:3.5, hitChance:0.8,  cost:600, color:0x334455, canFireWhileMoving:true, bounty:300, projectile:'salvo', splashRadius:12, splashFalloff:0.6 },
  carrier:  { domain:'sea',   hp:800, damage:20, range:30, speed:6,  fireRate:2.0, hitChance:0.7,  cost:700, color:0x556677, canLaunchFighters:true, altitude:0, canFireWhileMoving:true, bounty:400, projectile:'default', splashRadius:0, splashFalloff:1 },
