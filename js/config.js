...
export const UNIT_TYPES = {
  ...
  coastal:  { domain:'land',  hp:400, damage:100, range:120, speed:0, fireRate:2.5, hitChance:0.9, cost:400, color:0x554433, canFireWhileMoving:false, bounty:150, projectile:'ap', splashRadius:8, splashFalloff:0.5, seaOnly:true },
  ...
  submarine:{ domain:'sea',   hp:100, damage:150, range:50, speed:10, fireRate:3.5, hitChance:0.85, cost:350, color:0x223344, canFireWhileMoving:false, bounty:150, projectile:'ap', splashRadius:0, splashFalloff:1, seaOnly:true },
  battleship:{domain:'sea',   hp:600, damage:130, range:160, speed:12,  fireRate:3.5, hitChance:0.8,  cost:600, color:0x334455, canFireWhileMoving:true, bounty:300, projectile:'salvo', splashRadius:12, splashFalloff:0.6 },
  ...
  heli:     { domain:'air',   hp:120, damage:25, range:40, speed:25, fireRate:0.8, hitChance:0.8,  cost:350, color:0x4a4a4a, altitude:15, canFireWhileMoving:true, bounty:90, projectile:'burst', splashRadius:4, splashFalloff:0.5 },
  ...
  b2:          { domain:'air',   hp:800, damage:1000,range:25, speed:20, fireRate:3.0, hitChance:0.9, cost:800, color:0x333344, altitude:35, canFireWhileMoving:true, bounty:400, projectile:'carpet', splashRadius:25, splashFalloff:0.3, baseOnly:true, oneWay:true },
