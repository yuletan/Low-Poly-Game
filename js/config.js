...
export const UNIT_TYPES = {
  ...
  mlrs:     { domain:'land',  hp:80,  damage:15, range:110, speed:8,  fireRate:4.0, hitChance:0.6,  cost:350, color:0x5b5b3a, canFireWhileMoving:false, bounty:120, projectile:'salvo', splashRadius:8, splashFalloff:0.4 },
  ...
  cruiser:  { domain:'sea',   hp:200, damage:40, range:100, speed:10, fireRate:1.0, hitChance:0.9, cost:300, color:0x667788, canFireWhileMoving:true, bounty:100, projectile:'homing', splashRadius:0, splashFalloff:1, airOnly:true },
  ...
  heli:     { domain:'air',   hp:120, damage:25, range:40, speed:20, fireRate:0.8, hitChance:0.8,  cost:350, color:0x4a4a4a, altitude:15, canFireWhileMoving:true, bounty:90, projectile:'burst', splashRadius:4, splashFalloff:0.5 },
