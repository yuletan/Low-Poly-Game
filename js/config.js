...
export const UNIT_TYPES = {
  ...
  crusher:  { domain:'land',  hp:3000,damage:200, range:30, speed:10, fireRate:3.0, hitChance:0.85, cost:1000,color:0x553355, canFireWhileMoving:true, bounty:500, projectile:'ap', splashRadius:100, splashFalloff:0.5, crusher:true, baseTarget:true },
  ...
  medHeli:     { domain:'air',   hp:150, damage:0,  range:30, speed:15, fireRate:1.0, hitChance:0,   cost:500, color:0x44aa44, altitude:15, canFireWhileMoving:false, bounty:100, projectile:'default', splashRadius:0, splashFalloff:1, healer:true },
  minigunnerVehicle:{ domain:'land', hp:700, damage:5, range:40, speed:15, fireRate:0.1, hitChance:0.85, cost:800, color:0x886644, canFireWhileMoving:false, bounty:300, projectile:'burst', splashRadius:0, splashFalloff:1, buffDamage:0.3, buffRange:40 },
  megaMedic:        { domain:'land', hp:500, damage:0, range:0, speed:15, fireRate:99, hitChance:0, cost:1000, color:0x44aa88, canFireWhileMoving:false, bounty:400, projectile:'default', splashRadius:0, splashFalloff:1, buffHp:0.3, buffRange:30 },
  minigunner:       { domain:'land', hp:500, damage:5, range:40, speed:8, fireRate:0.1, hitChance:0.85, cost:400, color:0x887755, canFireWhileMoving:false, bounty:150, projectile:'burst', splashRadius:0, splashFalloff:1, buffInfantryHp:2.0, buffRange:30 },
